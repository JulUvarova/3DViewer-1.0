...
*/
 ...
 private:
  const QString fileMemory_{"view/settings/usersettings.xml"}; ///< File path for saving user settings
  ...
  bool isParallelProjection_; ///< Flag indicating if the projection is parallel
};