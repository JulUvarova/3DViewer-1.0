...
/**
 * @enum SaveType
 * @brief Enum representing the types of saving operations.
 */
enum class SaveType {
  Image,      ///< Represents saving an image file (e.g., BMP, JPEG).
  CustomGif,  ///< Represents saving a custom GIF file.
  CycledGif   ///< Represents saving a cycled GIF file.
};
...
class ControlWindow : public QWidget {
 ...
 private:
   ...
   * @param type The type of saving.
   */
  void SaveFile(const char* options, SaveType type);
};